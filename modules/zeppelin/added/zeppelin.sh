...
# Add recommended JVM options to run on containers
JAVA_OPTS+=" -XX:+UnlockExperimentalVMOptions -XX:+UseCGroupMemoryLimitForHeap -XX:+UseParallelOldGC -XX:+TieredCompilation -XX:TieredStopAtLevel=1 -XX:MinHeapFreeRatio=10 -XX:MaxHeapFreeRatio=20 -XX:GCTimeRatio=4 -XX:MaxMetaspaceSize=100m -XX:AdaptiveSizePolicyWeight=90 -Xss228k"
